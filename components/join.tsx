...
const Join = () => {
    return (
        <div className="w-full px-8 py-16 md:px-8 lg:px-16 bg-white">
            <div className="mx-auto max-w-4xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <a href="https://wa.me/2349162919586?text=Hello!%20I'm%20interested%20in%20joining%20your%20learning%20community.%20Can%20you%20provide%20more%20information?" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white hover:bg-green-600 px-8 py-3 text-lg font-medium rounded-full transition-colors flex items-center justify-center gap-2 animate-[ring_2s_ease-in-out_infinite] hover:animate-none" style={{fontFamily: 'SF Pro, -apple-system, BlinkMacSystemFont, sans-serif'}}>
