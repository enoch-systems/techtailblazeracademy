        ...
        <div className="w-full px-4 py-12 md:px-8 lg:px-16">
            <div className="mx-auto max-w-8xl grid gap-8 lg:grid-cols-2 items-center">
                ...
                <div className="space-y-6 order-2 lg:order-1">
                    ...
                    <a href="https://wa.me/2349162919586?text=Hello!%20I'm%20interested%20in%20inquiring%20about%20a%20specific%20course.%20Can%20you%20provide%20more%20information?" target="_blank" rel="noopener noreferrer" className="bg-green-500 text-white hover:bg-green-600 px-8 py-3 text-lg font-medium rounded-full transition-colors flex items-center justify-center gap-2 animate-[ring_2s_ease-in-out_infinite] hover:animate-none" style={{fontFamily: 'SF Pro, -apple-system, BlinkMacSystemFont, sans-serif'}}>
